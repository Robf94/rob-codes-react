...
const ClickSpark = ({
  ...
  return (
    <>
      <p className="pointer-events-none absolute z-10 flex h-full w-full items-center justify-center text-center text-xl">
        {isLoading ? "Loading..." : `${count} high fives provided!`}
      </p>
      <canvas
        ref={canvasRef}
        className="cursor-canvas z-5 absolute block h-full w-full select-none bg-white"
        onClick={handleClick}
      />
    </>
  );
